...
{
//Entering UserName 
WebElement u1 = cdriver.findElement(By.id("username"));
...
@Test (priority =1)
@Parameters({"firstname","lastname","phone","company","email"})
public void leadCreation(String firstname , String lastname , String phone , String company , String email) throws InterruptedException
{
	...
	//Selecting from dropdown
		...
		cdriver.findElement(By.name("firstname")).sendKeys(firstname);
		cdriver.findElement(By.name("lastname")).sendKeys(lastname);
		cdriver.findElement(By.name("phone")).sendKeys(phone);
		cdriver.findElement(By.name("company")).sendKeys(company);
		cdriver.findElement(By.name("email")).sendKeys(email);
